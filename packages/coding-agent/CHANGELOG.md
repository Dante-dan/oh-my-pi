...
- Preserved MCP `structuredContent` in tool result `details`, allowing eval callers to consume server data without parsing the model-facing JSON rendering ([shawnkoh/oh-my-pi#1](https://github.com/shawnkoh/oh-my-pi/issues/1)).
