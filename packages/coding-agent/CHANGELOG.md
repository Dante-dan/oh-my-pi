...
- Preserved MCP `structuredContent` in tool result `details`, allowing eval callers to consume server data without parsing the model-facing JSON rendering ([#13397](https://github.com/can1357/oh-my-pi/issues/13397), [#13398](https://github.com/can1357/oh-my-pi/pull/13398) by [@shawnkoh](https://github.com/shawnkoh)).
